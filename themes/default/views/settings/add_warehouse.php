    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div
                    class="controls"> <?php echo form_input('address', '', 'class="form-control" id="address" required="required"'); ?> </div>
            </div>
			<div class="form-group">
                <label class="control-label" for="details"><?php echo $this->lang->line("Hotel_Details"); ?></label>

                <div
                    class="controls"> <?php echo form_textarea('details', '', 'class="form-control" id="details" required="required"'); ?> </div>
            </div>
            <div class="form-group">
