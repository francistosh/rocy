        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Captain Order</legend>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-6">
                                        Name<br>
                                        <?= form_input('payment_name', $Settings->payment_name, 'class="form-control"'); ?>
                                    </div>

                                    <div class="col-sm-4 col-xs-5">
                                        ACC/Paybill No<br>
                                        <?= form_input('acc_no', $Settings->acc_no, 'class="form-control"'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-4">
                                        Enable<br>
                                        <?php
                                        echo form_dropdown('enable_tax', $ps, $Settings->enable_tax, 'id="enable_tax" class="form-control tip" required="required" style="width:100%;"');
                                        ?>
                                    ...
                                    <div class="col-sm-4 col-xs-4">
                                        VAT<br>
                                        <?= form_input('vat', $Settings->vat, 'class="form-control"'); ?>
                                    </div>

                                    <div class="col-sm-4 col-xs-4">
                                        Service Charge<br>
                                        <?= form_input('service_charge', $Settings->service_charge, 'class="form-control"'); ?>
                                    </div>

                                    <div class="col-sm-4 col-xs-4">
                                        Tourism Fund<br>
                                        <?= form_input('tourism_fund', $Settings->tourism_fund, 'class="form-control"'); ?>
                                    </div>
                                </div>
