<script>
    $(document).ready(function () {
        var oTable = $('#GuestData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('guests/getGuests') ?>',
            ...
            {column_number: 1, filter_default_label: "[<?=lang('group_name');?>]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[<?=lang('full_name');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('nationality');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('passport_id_number');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('gender');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('telephone');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('phone');?>]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('email_address');?>]", filter_type: "text", data: []},
