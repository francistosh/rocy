...
<script>
    $(document).ready(function () {
        var oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getInventoryProductsReport/?v=1'.$v) ?>',
            ...
            "aoColumns": [null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('Inventory Report'); ?> <?php
            if ($this->input->post('start_date')) {
