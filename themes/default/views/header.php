        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php } ?>
                    <?php if ($events) { ?>
                        <li class="dropdown hidden-xs"><a href="<?= site_url('calendar') ?>" class="btn tip" title="<?= lang('calendar') ?>"
                                                          data-placement="left" ><i
                                        class="fa fa-calendar"></i></a>
<!--                                <span class="number blightOrange black">--><?//= sizeof($events) ?><!--</span> </a>-->
                            <ul class="dropdown-menu pull-right content-scroll">
<!--                                <li class="dropdown-header"><i-->
...
<!--                                </li>-->
                    ...
                    <?php } ?>
                    <?php if (POS) { ?>
                        <li class="dropdown hidden-xs" style="display:none"><a class="btn bdarkGreen tip" title="<?= lang('pos') ?>"
                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_rooms">
                                <a class="dropmenu" href="#"><i class="fa fa-home"></i><span
                                            class="text"> <?= lang('rooms'); ?> </span> <span
                                            class="chevron closed"></span></a>
                                <ul>

                                    <li id="rooms_index"><a class="submenu"
                                                            href="<?= site_url('rooms'); ?>"><i
                                                    class="fa fa-home"></i><span
                                                    class="text"> <?= lang('list_rooms'); ?></span></a></li>

                                    <li id="rooms_add"><a class="submenu"
                                                          href="<?= site_url('rooms/add'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('add_room'); ?></span></a></li>
									
									<li id="rooms_add"><a class="submenu"
                                                          href="<?= site_url('customers/status/?sdate='.date('Y-m-d')); ?>" data-toggle="modal" data-target="#myModal"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('roomstat'); ?></span></a></li>
									<li id="rooms_add"><a class="submenu"
                                                          href="<?= site_url('customers/rooming/?sdate='.date('Y-m-d')); ?>" data-toggle="modal" data-target="#myModal"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('roomlist'); ?></span></a></li>
									<li id="rooms_add"><a class="submenu"
                                                          href="<?= site_url('customers/housekeeping');?>" data-toggle="modal" data-target="#myModal"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('housekeeping'); ?></span></a></li>
									<li id="rooms_index"><a class="submenu"
                                                            href="<?= site_url('rooms/housekeeping_list'); ?>"><i
                                                    class="fa fa-home"></i><span
                                                    class="text"> <?= lang('House_Keeping_List'); ?></span></a></li>
									
                                </ul>
                            </li>

                            <li class="mm_voucher">
                                <a class="dropmenu" href="#"><i class="fa fa-list"></i><span
                                            class="text"> <?= lang('vouchers'); ?> </span> <span
                                            class="chevron closed"></span></a>
                                <ul>
								<li id="voucher_add"><a class="submenu"
                                                          href="<?= site_url('vouchers/checkin'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('add_checkin'); ?></span></a></li>
								<li id="voucher_add"><a class="submenu"
                                                          href="<?= site_url('vouchers/checkincompany'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('Company_Checkin'); ?></span></a></li>
								<li id="voucher_add"><a class="submenu"
                                                          href="<?= site_url('rooms/guests'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('List_Guests'); ?></span></a></li>
								<li id="sales_index"><a class="submenu" href="<?= site_url('sales'); ?>"><i
                                                class="fa fa-heart"></i><span
                                                class="text"> <?= lang('List_Checkins'); ?></span></a></li>
									<li id="voucher_add"><a class="submenu"
                                                          href="<?= site_url('vouchers/add'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('add_voucher'); ?></span></a></li>
                                    <li id="voucher_index"><a class="submenu"
                                                            href="<?= site_url('vouchers'); ?>"><i
                                                    class="fa fa-list"></i><span
                                                    class="text"> <?= lang('list_vouchers'); ?></span></a></li>
									<li id="service-vouchers-add"><a class="submenu"
                                                            href="<?= site_url('service_vouchers/add'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('add_svoucher'); ?></span></a></li>
									<li id="service-vouchers-index"><a class="submenu"
                                                              href="<?= site_url('service_vouchers/index'); ?>"><i
                                                    class="fa fa-list"></i><span
                                                    class="text"> <?= lang('list_svouchers'); ?></span></a></li>
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_add_kitchen"><a class="submenu" href="<?= site_url('products/add_kitchen'); ?>"><i
                                                class="fa fa-plus-circle"></i><span
                                                class="text"> Add Cocktail Product</span></a></li>
                            ...
                            <li class="mm_quotes">
                                ...
                                <ul>
									...
									<li id="quotes_add"><a class="submenu" href="<?= site_url('quotes/transport'); ?>"><i
                                                class="fa fa-plus-circle"></i><span
                                                class="text"> <?= lang('Transport_Quotation'); ?></span></a></li>
                                </ul>
                            </li>
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    <?php if ($Owner) { ?>
                                        ...
                                        <li id="billers_index"><a class="submenu" href="<?= site_url('billers/add'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                    ...
                                    <li id="guests_index"><a class="submenu" href="<?= site_url('guests'); ?>"><i
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                   ...
                                   <!-- <li id="reports_quantity_alerts"><a
                                    ...
                                    <li id="reports_inventory"><a href="<?= site_url('reports/inventory') ?>"><i
                                                class="fa fa-barcode"></i><span
                                                class="text"> <?= lang('Inventory Report'); ?></span></a></li>
									...
									<li id="reports_sales"><a href="<?= site_url('sales/saledet_report') ?>"><i
                                                class="fa fa-money"></i><span
                                                class="text"> <?= lang('Sales Report'); ?></span></a></li>
									<li id="reports_sales"><a href="<?= site_url('sales/saledet_report') ?>"><i
                                                class="fa fa-money"></i><span
                                    ...
                                    <!--<li id="reports_profit_loss"><a href="<?= site_url('reports/profit_loss') ?>"><i
                                                ...
                                                <li id="reports_profit_loss"><a href="<?= site_url('sales/graph') ?>"><i
                                                class="fa fa-money"></i><span
                                                class="text"> <?= lang('Profit_and_loss_summary'); ?></span></a></li>-->
                                    <li id="reports_profit_loss"><a href="<?= site_url('sales/stmntofaccount') ?>"><i
                                                class="fa fa-money"></i><span
                                                class="text"> <?= lang('Customer Statement'); ?></span></a></li>
												<li id="reports_profit_loss"><a href="<?= site_url('sales/supplierstmt') ?>"><i
                                                class="fa fa-money"></i><span
                                                class="text"> <?= lang('Supplier Statement'); ?></span></a></li>
                        ...
                        <?php
                            ...
                            <?php if ($GP['vouchers-index']) { ?>
                                <li class="mm_vouchers">
                                    <a class="dropmenu" href="#"><i class="fa fa-list"></i><span
                                                class="text"> <?= lang('vouchers'); ?> </span> <span
                                                class="chevron closed"></span></a>
                                    <ul>
									 <?php if ($GP['vouchers-add']) { ?>
									 <li id="voucher_add"><a class="submenu"
                                                          href="<?= site_url('vouchers/checkin'); ?>"><i
                                                    class="fa fa-plus-circle"></i><span
                                                    class="text"> <?= lang('add_checkin'); ?></span></a></li>
                                            <li id="vouchers_add"><a class="submenu"
                                                                  href="<?= site_url('vouchers/add'); ?>"><i
                                                            class="fa fa-plus-circle"></i><span
                                                            class="text"> <?= lang('add_voucher'); ?></span></a></li>
                                        <?php } ?>
                                        <?php if ($GP['vouchers-index']) { ?>
                                            <li id="vouchers_index"><a class="submenu"
                                                                    href="<?= site_url('vouchers'); ?>"><i
                                                            class="fa fa-list"></i><span
                                                            class="text"> <?= lang('list_vouchers'); ?></span></a></li>
                                        <?php } ?>
                            ...
                            <?php if ($GP['service-vouchers-index']) { ?>


                                <li class="mm_svoucher">
                                    <a class="dropmenu" href="#"><i class="fa fa-list"></i><span
                                                class="text"> <?= lang('svouchers'); ?> </span> <span
                                                class="chevron closed"></span></a>
                                    <ul>
									<?php if ($GP['service-vouchers-add']) { ?>
                                        <li id="service-vouchers-add"><a class="submenu"
                                                                 href="<?= site_url('service_vouchers/add'); ?>"><i
                                                        class="fa fa-plus-circle"></i><span
                                                        class="text"> <?= lang('add_svoucher'); ?></span></a></li>
                            ...
                            <?php if ($GP['customers-index'] || $GP['suppliers-index'] || $GP['guests-index']) { ?>
                                <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                    <a class="dropmenu" href="#"><i class="fa fa-users"></i><span
                                            class="text"> <?= lang('people'); ?> </span> <span
                                            class="chevron closed"></span></a>
                                    <ul>
                                        ...
                                        <?php }
                                        if ($GP['guests-index']) {?>
                                        <li id="guests_index"><a class="submenu"
                                                                    href="<?= site_url('guests'); ?>"><i
                                                        class="fa fa-user-md"></i><span
                                                        class="text"> <?= lang('list_guests'); ?></span></a></li>
                                        <?php } ?>
                                    </ul>
