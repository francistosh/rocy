            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        $opts = array('service' => lang('service'),'standard' => lang('standard'), 'combo' => lang('combo'), 'digital' => lang('digital'));
                    ...
                    <div class="form-group">
                        <input name="inventory" type="checkbox" class="checkbox" id="inventory"
                               <?= isset($_POST['inventory']) ? 'checked="checked"' : '' ?>/><label for="inventory"
                    ...
                    <div class="form-group all">
                        ...
                        <div class="controls" id="subcat_data"> <?php
                            echo form_input('subcategory', ($product ? $product->subcategory_id : 0), 'class="form-control" id="subcategory"  placeholder="' . lang("select_category_to_load") . '"');
                            ?>
                        </div>
                    </div>
                    <div class="form-group all">
                    ...
                    <div class="form-group standard">
                        ...
                        <div
                            class="input-group"> <?= form_input('alert_quantity', (isset($_POST['alert_quantity']) ? $_POST['alert_quantity'] : ($product ? $this->sma->formatNumber($product->alert_quantity) : 0)), 'class="form-control tip" id="alert_quantity"') ?>
				...
				<div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                               ...
                               <?php echo form_input('from_date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("To_date", "todate") ?>
                               <?php echo form_input('todate', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="todate"'); ?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount") ?>
                                 <?= form_input('rsdnt_amount', (isset($_POST['price']) ? $_POST['price'] : ($product ? $this->sma->formatDecimal($product->price) : '')), 'class="form-control tip" id="rsdnt_amount"') ?>
                            </div>
                        </div>
                       ...
                       <div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("NonResident_Amount ($)", "nrsdnt_amount") ?>
                                 <?= form_input('nrsdnt_amount', (isset($_POST['price']) ? $_POST['price'] : ($product ? $this->sma->formatDecimal($product->price) : '')), 'class="form-control tip" id="nrsdnt_amount"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                               ...
                               <?php echo form_input('from_date2', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date2"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                                ...
                                <?php echo form_input('to_date2', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date2"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount2") ?>
                                <?= form_input('rsdnt_amount2', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount2"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amount2") ?>
                                <?= form_input('nrsdnt_amount2', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount2"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date3") ?>
                               <?php echo form_input('from_date3', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date3"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date3', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date3"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount3") ?>
                                <?= form_input('rsdnt_amount3', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount3"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amount3") ?>
                                <?= form_input('nrsdnt_amount3', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount3"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date4") ?>
                               <?php echo form_input('from_date4', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date4"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date4', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date4"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount4") ?>
                                <?= form_input('rsdnt_amount4', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount4"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amount4") ?>
                                <?= form_input('nrsdnt_amount4', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount4"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date5") ?>
                               <?php echo form_input('from_date5', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date5"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date5', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date5"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount5") ?>
                                <?= form_input('rsdnt_amount5', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount5"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun5") ?>
                                <?= form_input('nrsdnt_amount5', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount5"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date6") ?>
                               <?php echo form_input('from_date6', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date6"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date6', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date6"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount6") ?>
                                <?= form_input('rsdnt_amount6', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount6"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun6") ?>
                                <?= form_input('nrsdnt_amount6', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount6"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date7") ?>
                               <?php echo form_input('from_date7', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date7"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date7', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date7"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount7") ?>
                                <?= form_input('rsdnt_amount7', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount7"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun7") ?>
                                <?= form_input('nrsdnt_amount7', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount7"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date8") ?>
                               <?php echo form_input('from_date8', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date8"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date8', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date8"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount8") ?>
                                <?= form_input('rsdnt_amount8', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount8"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun8") ?>
                                <?= form_input('nrsdnt_amount8', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount8"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date9") ?>
                               <?php echo form_input('from_date9', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="from_date9"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                              ...
                              <?php echo form_input('to_date9', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control date" id="to_date9"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount9") ?>
                                <?= form_input('rsdnt_amount9', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="rsdnt_amount9"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun9") ?>
                                <?= form_input('nrsdnt_amount9', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="nrsdnt_amount9"') ?>
                            </div>
                        </div>
                    </div>
					</div>
