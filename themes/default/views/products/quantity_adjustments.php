...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, null, null, {"mRender": decimalFormat}, null, null,null,null,null,null, {"bSortable": false}]
            ...
            {column_number: 5, filter_default_label: "[<?=lang('type');?>]", filter_type: "text", data: []},
             {column_number: 6, filter_default_label: "[<?=lang('reason');?>]", filter_type: "text", data: []},
              {column_number: 7, filter_default_label: "[<?=lang('reference');?>]", filter_type: "text", data: []},
            {column_number:8, filter_default_label: "[<?=lang('warehouse');?>]", filter_type: "text", data: []},
             {column_number: 9, filter_default_label: "[<?=lang('returned_by');?>]", filter_type: "text", data: []},
              {column_number: 10, filter_default_label: "[<?=lang('checked_by');?>]", filter_type: "text", data: []},
        ], "footer");
                    ...
                    <table id="dmpData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th class="col-xs-1"><?= lang("type"); ?></th>
                             <th class="col-xs-1"><?= lang("Reason"); ?></th>
                              <th class="col-xs-1"><?= lang("Reference"); ?></th>
                            <th class="col-xs-2"><?= lang("warehouse"); ?></th>
                             <th class="col-xs-1"><?= lang("Returned_by"); ?></th>
                              <th class="col-xs-1"><?= lang("Checked_by"); ?></th>
