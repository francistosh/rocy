        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div class="form-group">
                        ...
                        echo form_dropdown('warehouse', $cat, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ($warehouse ? $product->warehouse : '')), 'class="form-control select" id="warehouse" placeholder="' . lang("select") . " " . lang("warehouse_name") . '" required="required" style="width:100%"')
                        ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input name="inventory" type="checkbox" class="checkbox" id="inventory"
                               value="" <?= isset($_POST['inventory']) ? 'checked="checked"' : '' ?>/><label for="inventory"
                                                                                                      class="padding05"><?= lang('Inventory') ?></label>
                    </div>
                    ...
                    <div class="digital" style="display:none;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                               ...
                               <?php echo form_input('from_date', (isset($_POST['date']) ? $_POST['date'] : ($product->portion1qty ? date('d/m/Y',strtotime($product->portion1)) : '')), 'class="form-control date" id="from_date"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("To_date", "todate") ?>
                               <?php echo form_input('todate', (isset($_POST['date']) ? $_POST['date'] : date('d/m/Y',strtotime($product->to_date))), 'class="form-control date" id="todate"'); ?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount") ?>
                                 <?= form_input('rsdnt_amount', (isset($_POST['price']) ? $_POST['price'] : ($product ? $this->sma->formatDecimal($product->price) : $product->portion1qty)), 'class="form-control tip" id="rsdnt_amount"') ?>
                            </div>
                        </div>

                       <div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("NonResident_Amount ($)", "nrsdnt_amount") ?>
                                 <?= form_input('nrsdnt_amount', (isset($_POST['price']) ? $_POST['price'] : $product->nrsdnt_amount), 'class="form-control tip" id="nrsdnt_amount"') ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date2") ?>
                               <?php echo form_input('from_date2', (isset($_POST['date']) ? $_POST['date'] : ($product->portion2qty ? date('d/m/Y',strtotime($product->portion2)) : '')), 'class="form-control date" id="from_date2"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date2") ?>
                                <?php echo form_input('to_date2', (isset($_POST['date']) ? $_POST['date'] :  ($product->portion2qty ? date('d/m/Y',strtotime($product->todate2)) : '')), 'class="form-control date" id="to_date2"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount2") ?>
                                <?= form_input('rsdnt_amount2', (isset($_POST['rsdnt_amount2']) ? $_POST['rsdnt_amount2'] : $product->portion2qty), 'class="form-control tip" id="rsdnt_amount2"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amount2") ?>
                                <?= form_input('nrsdnt_amount2', (isset($_POST['nrsdnt_amount2']) ? $_POST['nrsdnt_amount2'] :  $product->nrsdnt_amount2), 'class="form-control tip" id="nrsdnt_amount2"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date3") ?>
                               <?php echo form_input('from_date3', (isset($_POST['date']) ? $_POST['date'] : ($product->portion3qty ? date('d/m/Y',strtotime($product->portion3)) : '')), 'class="form-control date" id="from_date3"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date3") ?>
                              <?php echo form_input('to_date3', (isset($_POST['date']) ? $_POST['date'] : ($product->portion3qty ? date('d/m/Y',strtotime($product->todate3)) :'')), 'class="form-control date" id="to_date3"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount3") ?>
                                <?= form_input('rsdnt_amount3', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion3qty ? $product->portion3qty : '')), 'class="form-control tip" id="rsdnt_amount3"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amount3") ?>
                                <?= form_input('nrsdnt_amount3', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion3qty ? $product->nrsdnt_amount3 : '')), 'class="form-control tip" id="nrsdnt_amount3"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date4") ?>
                               <?php echo form_input('from_date4', (isset($_POST['date']) ? $_POST['date'] : ($product->portion4qty ? date('d/m/Y',strtotime($product->portion4)) : '')), 'class="form-control date" id="from_date4"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date4") ?>
                              <?php echo form_input('to_date4', (isset($_POST['date']) ? $_POST['date'] : ($product->portion4qty ? date('d/m/Y',strtotime($product->todate4)) : '')), 'class="form-control date" id="to_date4"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount4") ?>
                                <?= form_input('rsdnt_amount4', (isset($_POST['cf6']) ? $_POST['cf6'] :  ($product->portion4qty ? $product->portion4qty : '')), 'class="form-control tip" id="rsdnt_amount4"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amount4") ?>
                                <?= form_input('nrsdnt_amount4', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion4qty ? $product->nrsdnt_amount4 : '')), 'class="form-control tip" id="nrsdnt_amount4"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date5") ?>
                               <?php echo form_input('from_date5', (isset($_POST['date']) ? $_POST['date'] : ($product->portion5qty ? date('d/m/Y',strtotime($product->portion5)) : '')), 'class="form-control date" id="from_date5"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date5") ?>
                              <?php echo form_input('to_date5', (isset($_POST['date']) ? $_POST['date'] : ($product->portion5qty ? date('d/m/Y',strtotime($product->todate5)) : '')), 'class="form-control date" id="to_date5"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount5") ?>
                                <?= form_input('rsdnt_amount5', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion5qty ? $product->portion5qty : '')), 'class="form-control tip" id="rsdnt_amount5"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun5") ?>
                                <?= form_input('nrsdnt_amount5', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion5qty ? $product->nrsdnt_amount5 : '')), 'class="form-control tip" id="nrsdnt_amount5"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date6") ?>
                               <?php echo form_input('from_date6', (isset($_POST['date']) ? $_POST['date'] : ($product->portion6qty ? date('d/m/Y',strtotime($product->portion6)) : '')), 'class="form-control date" id="from_date6"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date6") ?>
                              <?php echo form_input('to_date6', (isset($_POST['date']) ? $_POST['date'] : ($product->portion6qty ? date('d/m/Y',strtotime($product->todate6)) : '')), 'class="form-control date" id="to_date6"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount6") ?>
                                <?= form_input('rsdnt_amount6', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion6qty ? $product->portion6qty : '')), 'class="form-control tip" id="rsdnt_amount6"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun6") ?>
                                <?= form_input('nrsdnt_amount6', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion6qty ? $product->nrsdnt_amount6 : '')), 'class="form-control tip" id="nrsdnt_amount6"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date7") ?>
                               <?php echo form_input('from_date7', (isset($_POST['date']) ? $_POST['date'] : ($product->portion7qty ? date('d/m/Y',strtotime($product->portion7)) : '')), 'class="form-control date" id="from_date7"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date7") ?>
                              <?php echo form_input('to_date7', (isset($_POST['date']) ? $_POST['date'] : ($product->portion7qty ? date('d/m/Y',strtotime($product->todate7)) : '')), 'class="form-control date" id="to_date7"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount7") ?>
                                <?= form_input('rsdnt_amount7', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion7qty ? $product->portion7qty : '')), 'class="form-control tip" id="rsdnt_amount7"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun7") ?>
                                <?= form_input('nrsdnt_amount7', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion7qty ? $product->nrsdnt_amount7 : '')), 'class="form-control tip" id="nrsdnt_amount7"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date8") ?>
                               <?php echo form_input('from_date8', (isset($_POST['date']) ? $_POST['date'] : ($product->portion8qty ? date('d/m/Y',strtotime($product->portion8)) : '')), 'class="form-control date" id="from_date8"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date8") ?>
                              <?php echo form_input('to_date8', (isset($_POST['date']) ? $_POST['date'] : ($product->portion8qty ? date('d/m/Y',strtotime($product->todate8)) : '')), 'class="form-control date" id="to_date8"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount8") ?>
                                <?= form_input('rsdnt_amount8', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion8qty ? $product->portion8qty : '')), 'class="form-control tip" id="rsdnt_amount8"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun8") ?>
                                <?= form_input('nrsdnt_amount8', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion8qty ? $product->nrsdnt_amount8 : '')), 'class="form-control tip" id="nrsdnt_amount8"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("From_date", "from_date9") ?>
                               <?php echo form_input('from_date9', (isset($_POST['date']) ? $_POST['date'] : ($product->portion9qty ? date('d/m/Y',strtotime($product->portion9)) : '')), 'class="form-control date" id="from_date9"'); ?>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("To_date", "to_date9") ?>
                              <?php echo form_input('to_date9', (isset($_POST['date']) ? $_POST['date'] : ($product->portion9qty ? date('d/m/Y',strtotime($product->todate9)) : '')), 'class="form-control date" id="to_date9"'); ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                               <?= lang("Resident_Amount (Ksh)", "rsdnt_amount9") ?>
                                <?= form_input('rsdnt_amount9', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion9qty ? $product->portion9qty : '')), 'class="form-control tip" id="rsdnt_amount9"') ?>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="form-group all">
                                <?= lang("NonResident_Amount ($)", "nrsdnt_amoun9") ?>
                                <?= form_input('nrsdnt_amount9', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product->portion9qty ? $product->nrsdnt_amount9 : '')), 'class="form-control tip" id="nrsdnt_amount9"') ?>
                            </div>
                        </div>
                    </div>
					</div>
