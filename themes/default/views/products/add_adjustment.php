    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label for="reason"><?php echo $this->lang->line("reason/reference"); ?></label>
               <?php $optionss = array('stocktake' => lang('stocktake'), 'salereturn' => lang('salereturn'));?>
                <div class="row"> <div class="col-md-6"><?= form_dropdown('reason', $optionss, set_value('type', 'salereturn'), 'class="form-control tip" id="type"  required="required"'); ?></div><div class="col-md-6"><?php echo form_input('reference', (isset($_POST['reference']) ? $_POST['reference'] : ""), 'class="form-control input-tip" placeholder="reference" id="reference" required="required"'); ?></div></div>
            ...
            <div class="form-group">
                <label for="checkedby"><?php echo $this->lang->line("checked_by"); ?></label>
                <?php   $q= $this->db->get('users');
                       foreach (($q->result()) as $row) {
                $optionsss[$row->first_name." ".$row->last_name] = $row->first_name." ".$row->last_name;
            }
                        echo form_dropdown('checked_by', $optionsss, (isset($_POST['checked_by']) ? $_POST['checked_by'] : ''), 'id="option" class="form-control input-pop" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("checked_by") . '" required="required"');?>
            ...
            <div class="form-group">
                ...
                <div
                    class="controls"> <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : ""), 'class="form-control" id="note"  style="margin-top: 10px; height: 100px;"'); ?> </div>
            </div>
