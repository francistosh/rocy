<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li class=""><a href="#PI" class="tab-grey"><?= lang('Prices') ?></a></li>
    </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?php echo lang('list_results'); ?></p>
                                ...
                                <tr><th>From Date</th><th>To Date</th><th>Resident Price</th><th>NonResident Price</th><th>Actions</th></tr>  
                                
                                <tr><td>
								
								<?=date('d-m-Y',strtotime($product->portion1))?></td><td><?=date('d-m-Y',strtotime($product->to_date))?></td><td><?= number_format($product->portion1qty,2)?></td><td><?= number_format($product-> 	nrsdnt_amount,2).' $'?></td><td><a href="#">X</a></td></tr> 
                             
                                    <?php if($product->portion2qty){ ?>
                                 <tr><td><?=date('d-m-Y',strtotime($product->portion2))?></td><td><?=date('d-m-Y',strtotime($product->todate2 ))?></td><td><?= number_format($product->portion2qty,2)?></td><td><?= number_format($product->nrsdnt_amount2,2).' $'?></td><td><a href="#">X</a></td></tr>  
                                <?php }?>
                                    <?php if($product->portion3qty){ ?>
                                  <tr><td><?=date('d-m-Y',strtotime($product->portion3))?></td><td><?=date('d-m-Y',strtotime($product->todate3 ))?></td><td><?= number_format($product->portion3qty,2)?></td><td><?= number_format($product->nrsdnt_amount3,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
                                    <?php if($product->portion4qty){ ?>
                                <tr><td><?=date('d-m-Y',strtotime($product->portion4))?></td><td><?=date('d-m-Y',strtotime($product->todate4 ))?></td><td><?= number_format($product->portion4qty,2)?></td><td><?= number_format($product->nrsdnt_amount4,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
                                    <?php if($product->portion5qty){ ?>
                                 <tr><td><?=date('d-m-Y',strtotime($product->portion5))?></td><td><?=date('d-m-Y',strtotime($product->todate5 ))?></td><td><?= number_format($product->portion5qty,2)?></td><td><?= number_format($product->nrsdnt_amount5,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
							   <?php if($product->portion6qty){ ?>
                                 <tr><td><?=date('d-m-Y',strtotime($product->portion6))?></td><td><?=date('d-m-Y',strtotime($product->todate6))?></td><td><?= number_format($product->portion6qty,2)?></td><td><?= number_format($product->nrsdnt_amount6,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
								<?php if($product->portion7qty){ ?>
                                 <tr><td><?=date('d-m-Y',strtotime($product->portion7))?></td><td><?=date('d-m-Y',strtotime($product->todate7))?></td><td><?= number_format($product->portion7qty,2)?></td><td><?= number_format($product->nrsdnt_amount7,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
								<?php if($product->portion8qty){ ?>
                                 <tr><td><?=date('d-m-Y',strtotime($product->portion8))?></td><td><?=date('d-m-Y',strtotime($product->todate8))?></td><td><?= number_format($product->portion8qty,2)?></td><td><?= number_format($product->nrsdnt_amount8,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
								<?php if($product->portion9qty){ ?>
                                 <tr><td><?=date('d-m-Y',strtotime($product->portion9))?></td><td><?=date('d-m-Y',strtotime($product->todate9))?></td><td><?= number_format($product->portion9qty,2)?></td><td><?= number_format($product->nrsdnt_amount9,2).' $'?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
                        </table>
