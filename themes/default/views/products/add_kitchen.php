        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        <?= lang("Product Nonresident Price", "nonresident_price") ?>
                        <?= form_input('nonresident_price', (isset($_POST['nonresident_price']) ? $_POST['nonresident_price'] : ($product ? $this->sma->formatDecimal($product->nrsdnt_amount) : '')), 'class="form-control tip" id="nonresident_price" required="required"') ?>
                    </div>
