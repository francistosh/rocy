...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_svoucher'); ?></h2>
    </div>
    <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'edit_service_voucher');
    echo form_open_multipart("service_vouchers/edit/".$svoucher->voucher_id); ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="voucher" id="voucher" required >
                            ...
                            <option <?php if($svoucher->voucher_id==$voucher->id){ echo 'selected="selected"'; } ?> value="<?php echo $voucher->id ?>"><?php echo $voucher->group_name?> </option>
                            <?php } ?>
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <textarea cols="1" rows="2" name="special_instructions" id="special_instructions">
                            <?php echo $svoucher->special_instructions; ?>
                        </textarea>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="arrival_time" id="arrival_time" required>
                                <?php if($svoucher->arrival_time == "BB"){?>
                                    <option value="BB" selected>Before Breakfast</option>
                                ...
                                <?php if($svoucher->arrival_time == "BL"){?>
                                    ...
                                    <option value="BL" selected>Before Lunch</option>
                                    <option value="BPL">Before PLunch</option>
                                    <option value="BD">Before Dinner</option>
                                <?php }?>
                                <?php if($svoucher->arrival_time == "BPL"){?>
                                    <option value="BB">Before Breakfast</option>
                                    <option value="BL">Before Lunch</option>
                                    <option value="BPL" selected>Before PLunch</option>
                                    <option value="BD">Before Dinner</option>
                                <?php }?>
                                <?php if($svoucher->arrival_time == "BD"){?>
                                    ...
                                    <option value="BL">Before Lunch</option>
                                    <option value="BPL">Before PLunch</option>
                                    <option value="BD" selected>Before Dinner</option>
                                <?php }?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <?php echo form_submit('edit_service_voucher', lang('edit_svoucher'), 'class="btn btn-primary"'); ?>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e){
        ...
        $.ajax({
            type:"get",
            url: '<?= site_url('sales/getVoucher'); ?>',
            data:{id:$("select#voucher option").filter(":selected").val()},
            dataType: 'json',
            cache:false,
            success: function(response) {
                checkin=new Date(response["check_in"]);
                ...
                var ml_plan = $("select#arrival_time option").filter(":selected").val();
