...
<div class="box">
    ...
    echo form_open_multipart("service_vouchers/add"); ?>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    ...
                    <?php //if ($Owner || $Admin) { ?>
                        ...
                        <div class="form-group">
                            <label>Arrival for</label>
                            <select class="form-control" name="arrival_time" id="arrival_time" required>
                                <option value="BB">Breakfast</option>
                                <option value="BL">Lunch</option>
                                <option value="BPL">PLunch</option>
                                <option value="BD">Dinner</option>
                            </select>
                        </div>
