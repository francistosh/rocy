<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('check_in_guest'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'check_in-guest-form');
        echo form_open_multipart("service_vouchers/checkin/" . $service_voucher->voucher_id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("dob", "dob"); ?> Format mm/dd/yyyy
                        <input type="text" name="data[0][dob]" class="form-control" id="dob" required="required"/>
                    </div>

                    <div class="form-group">
                        <?= lang("passport_expiry", "passport_expiry"); ?> Format mm/dd/yyyy
                        <input type="text" name="data[0][passport_expiry]" class="form-control" id="passport_expiry" />
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <?= lang("room", "room"); ?>
                        <input type="text" name="data[0][room]" class="form-control" id="room" required="required"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <?php echo form_submit('check_in_guest', lang('check_in_guest'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
...
<script type="text/javascript">
    $(document).ready(function (e) {
        $('#check_in-guest-form').bootstrapValidator({
            feedbackIcons: {
                valid: 'fa fa-check',
                invalid: 'fa fa-times',
