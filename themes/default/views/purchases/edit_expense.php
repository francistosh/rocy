            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                $optionsss[$row->first_name." ".$row->last_name] = $row->first_name." ".$row->last_name;
                        ...
                        echo form_dropdown('employee', $optionsss, (isset($_POST['employee']) ? $_POST['employee'] : ''), 'id="option" class="form-control input-pop" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("employee") . '" required="required"');?>
