<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="checkedby"><?php echo $this->lang->line("Employee"); ?></label>
                <?php   $q= $this->db->get('users');
                $optionsss['none']='Select Employee';
                       foreach (($q->result()) as $row) {
                $optionsss[$row->first_name." ".$row->last_name] = $row->first_name." ".$row->last_name;
            }
                        echo form_dropdown('employee', $optionsss, (isset($_POST['employee']) ? $_POST['employee'] : $employee), 'id="option" class="form-control input-pop" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("employee") . '" required="required"');?>
