    ...
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, {"mRender": currencyFormat}, null, null,null, {
                "bSortable": false,
                "mRender": attachment
            }, {"bSortable": false}],
            ...
            {column_number: 5, filter_default_label: "[<?=lang('created_by');?>]", filter_type: "text", data: []},
             {column_number: 6, filter_default_label: "[<?=lang('employee');?>]", filter_type: "text", data: []},
        ], "footer");
                ...
                <div class="table-responsive">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th class="col-xs-2"><?php echo $this->lang->line("employee"); ?></th>
