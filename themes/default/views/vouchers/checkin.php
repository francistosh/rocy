    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("vouchers/checkin", $attrib)
                ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4">
                            ...
                            foreach ($customers as $customer) {
							 ...
							 echo form_dropdown('chkincustomer', $cast, (isset($_POST['customer']) ? $_POST['customer'] : ($product ? $product->category_id : '')), 'class="form-control select" id="chkincustomer" placeholder="' . lang("Select_Customer") . '" required="required" style="width:100%"')
                        ...
                        <input type="text" name="chkindate" class="form-control input-tip date" id="chkindate" required="required" autocomplete="off"/>
							...
							<div class="col-md-4">
                                <div class="form-group">
									...
									<input type="text" name="check_out" class="form-control input-tip date " id="check_out" required="required" autocomplete="off" />
                        ...
                        <?= lang("Room Numbers", "type") ?>
                            ...
                            <div class="form-group">
                                ...
                                foreach ($categories as $category) {
                                    ...
                                    echo form_input('chkinrmsview'.$category->id, '0', 'class="form-control" readonly id="room_view'.$category->id.'"');
										?>
									                              <?php }
                                ?>
                        ...
                        <?= lang("No_of_Adults", "type") ?>
                            ...
                            <div class="form-group">
                                ...
                                foreach ($categories as $category) {
                                    ...
                                    echo form_input('adults'.$category->id, '0', 'class="form-control " id="adults'.$category->id.'"');
										?>
									                              <?php }
                                ?>
					...
					<div class="input-group-addon no-print" style="padding: 2px 5px;"><a
                                                        href="<?= site_url('customers/status/?room_type=all&sdate='.$stdate)?>" id="add-customer"
                                                        class="external" data-toggle="modal" data-target="#myModal"><i
                                                            class="fa fa-2x fa-plus-circle" id="addIcon"></i></a></div>
					</div>
					<div class="col-md-3">
					<?= lang("Bill to Room", "type") ?>
                        <input type="text" name="billtoroom_view" placeholder="value" class="form-control" id="billtoroom_view" required readonly/>
                            <div class="form-group">
					...
					<?= lang("Bill to Room", "type") ?>
                        <input type="text" name="billtoroom" placeholder="value" class="form-control" id="billtoroom" required readonly/>
                            <div class="form-group">
