...
<!--            <h3 style="text-transform:uppercase;"><b>$inv->id$biller->company != '-' ? $biller->company : $biller->name; ?></b></h3>-->
           ...
           //echo "<br>" . lang("tel") . ": " . $biller->phone . "<br>";
			...
			foreach ($payment as $records){ 
				$date = $records->date;
				$refno = $records->reference_no;
				$billno = $records->id;
				$servedby = $records->username;
				$roomname = $records->roomname;
				$catname = $records->catname;
				$nights = $records->total_nights;
				$meal_plan = $records->meal_plan;
				$grand_total = $records->grand_total;
				$customer = $records->customer;
				
			}
            echo "<p>" . lang("reference_no") . ": " . $refno . "<br>";
           // echo lang("customer") . ": " . $inv->customer . "   -    "."No of Customer(s) : ". $inv->count_cust.  "<br>";
           // echo "Cashier" . ": " . $inv->cashier . "</br>";
           // echo "Chef" . ": " . $inv->chef . "</br>";
            echo lang("date") . ": " . $this->sma->hrld($date);
           echo  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   Receipt No: ". $billno."</p>";
		   echo lang("Client") . "  : " . $customer;
            ?>
            <div style="clear:both;"></div>
            <table class="table table-striped table-condensed">
                <tbody>
				<tr><td style="text-align:center" colspan="2">Room No</td><td align="centre">Room Type</td><td align="centre">Days</td></tr>
                <?php
				echo '<tr style="font-size:15px"><td colspan="2">#:&nbsp;&nbsp;'.$roomname.'</td><td>'.$catname.'</td><td>'.$nights.'</td></tr>';
                ?>
				<tr><td style="text-align:center" colspan="2">Particular</td><td align="centre">Rate</td><td align="centre">Total</td></tr>
				 <?php
				echo '<tr style="font-size:15px"><td colspan="2">#:&nbsp;&nbsp;'.$meal_plan.'</td><td>'.$nights.' x '.number_format($grand_total/$nights,2).'</td><td>'.number_format($grand_total,2).'</td></tr>';
                ?>
                ...
                //if ($inv->product_tax != 0) {
                    ...
                    echo '<tr><th colspan="3" style="text-align:right;font-size:11px">' . lang("Sub Total") . '</th><th class="text-right" style="font-size:11px">' . $this->sma->formatMoney($grand_total- (0.02 * $grand_total +($grand_total*0.16)) ) . '</th></tr>';
                    echo '<tr ><td colspan="3" style="text-align:right; font-size:11px" >' . lang("VAT 16%") . '</td><td class="text-right" style="font-size:11px">' . $this->sma->formatMoney($grand_total*0.16) . '</td></tr>';
					// echo '<tr ><td colspan="4"><i>All prices are VAT inclusive</i></td></tr>';
                    echo '<tr><td colspan="3" style="text-align:right;font-size:11px">' . lang("Catering Levy 2%") . '</td><td class="text-right" style="font-size:11px">' . $this->sma->formatMoney(0.02 * $grand_total) . '</td></tr>';
               ...
               ?>
                    ...
                    <tr style="font-size:15px">
                        ...
                        <th class="text-right"><?= $this->sma->formatMoney($grand_total); ?></th>
                    </tr>
   ...
   echo 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx<br>';
               ...
               <!--   <tr>
                 ...
                 <tr style="font-size:15px"><td colspan="2"><br>Paybill No: 400222</td><td align="center" colspan="2"><br>Account No: 80229#</td></tr>
                  <tr><td colspan="4">
				  <?php
				  echo 'You were served by : '.$servedby.'&nbsp;';
				  ?>
				  </td></tr>
				</tfoot>
            </table>
...
<?php } ?>
    ...
    <span class="col-xs-12">
        <a class="btn btn-block btn-warning" href="<?= site_url('sales'); ?>"><?= lang("back_to_sales"); ?></a>
    </span>
    <?php if (!$pos_settings->java_applet) { ?>
        <div style="clear:both;"></div>
