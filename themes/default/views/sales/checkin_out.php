<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('CheckIn/Out'); ?></h4>
        </div>
                ...
                <?php if ($Owner || $Admin) { ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?= lang("Check In Date", "date"); ?>
                            <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control datetime" id="date" required="required"'); ?>
                        </div>
                    </div>
					<div class="col-sm-6">
                        <div class="form-group">
                            <?= lang("Check Out Date", "c_outdate"); ?>
                            <?= form_input('c_outdate', (isset($_POST['c_outdate']) ? $_POST['c_outdate'] : ""), 'class="form-control datetime" id="c_outdate" required="required"'); ?>
                        </div>
                    </div>
                <?php } ?>
                <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by"
                                        ...
                                        <option value="mpesa"><?= lang("directtransfer"); ?></option>
                                        <option value="mpesa"><?= lang("exchange"); ?></option>
