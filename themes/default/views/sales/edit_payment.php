                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by">
                                        ...
                                        <option
                                            value="cash"<?= $payment->paid_by == 'cash' ? ' checked="checked"' : '' ?>><?= lang("cash"); ?></option>
                                        <option
                                                value="cheque"<?= $payment->paid_by == 'cheque' ? ' checked="checked"' : '' ?>><?= lang("cheque"); ?></option>
                                        <option
                                                value="bank"<?= $payment->paid_by == 'bank' ? ' checked="checked"' : '' ?>>Bank></option>
                                        <option
                                                value="mpesa"<?= $payment->paid_by == 'mpesa' ? ' checked="checked"' : '' ?>>Mpesa</option>
                                        <option
                                            value="cc"<?= $payment->paid_by == 'cc' ? ' checked="checked"' : '' ?>><?= lang("cc"); ?></option>
