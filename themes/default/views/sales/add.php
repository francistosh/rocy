<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		localStorage.setItem('chkindate', '<?= $this->sma->hrld($quote->chkindate) ?>');
		localStorage.setItem('chkoutdate', '<?= $this->sma->hrld($quote->chkoutdate) ?>');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php } ?>
							<div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Check_In", "chkindate"); ?>
                                    <?php echo form_input('chkindate', (isset($_POST['chkindate']) ? $_POST['chkindate'] : date('d/m/Y')), 'class="form-control input-tip date" id="chkindate" required="required"'); ?>
                                </div>
                            </div>
							<div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Check_Out", "chkoutdate"); ?>
                                    <?php echo form_input('chkoutdate', (isset($_POST['chkoutdate']) ? $_POST['chkoutdate'] : date('d/m/Y')), 'class="form-control input-tip date" id="chkoutdate" required="required"'); ?>
                                </div>
                            </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <?= lang("Category", "qcategory") ?>
                        <?php
                        $cat[''] = "";
                        foreach ($categories as $category) {
                            $cat[$category->id] = $category->name;
                        }
                        echo form_dropdown('qcategory', $cat, (isset($_POST['category']) ? $_POST['category'] : $quote->category_id), 'class="form-control select" id="qcategory" placeholder="' . lang("select") . " " . lang("category") . '" required="required" style="width:100%"')
                        ?>
							</div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
									...
									<div class="col-md-4">
                                        <div class="form-group">
                                           <?= lang("Residence", "slrtype") ?>
                                            <div class="input-group">
                                               
                        <?php
                        $opts = array('resident' => lang('Resident'),'nonresident' => lang('Non-Resident'));
                        echo form_dropdown('slrtype', $opts, (isset($_POST['slrtype']) ? $_POST['slrtype'] : ($product ? $product->type : '')), 'class="form-control" id="slrtype" required="required"');
                        ?>
                                    ...
                                    <table id="slTable"
                                        ...
                                        <tr>
                                            ...
                                            if ($Settings->product_serial) {
                                                echo '<th class="col-md-2">' . lang("No_of_Rooms") . '</th>';
                                            }
                                            ?>
                                            <th class="col-md-1"><?= lang("Price_per_Pax"); ?></th>
                                            <th class="col-md-1"><?= lang("No_of_Pax"); ?></th>
                                            <?php
