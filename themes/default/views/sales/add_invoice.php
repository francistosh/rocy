...
<div class="box">
    ...
    echo form_open_multipart("sales/add"); ?>
                ...
                <div class="col-md-12">
                    ...
                    <?php if ($Owner || $Admin) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="expiry_date" id="expiry_date" type="date" required>
                        </div>
                    ...
                    <div class="form-group">
                        <?php echo form_submit('add_sale', lang('add_sale'), 'class="btn btn-primary"'); ?>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $('#voucher').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    '</tr>' +
                    '</tfoot>');
                    if(response["singles_room"]>0){
                        $('#order_table_body').append('<tr>' +
                        '<td>Single</td>' +
                        '<td><input class="form-control input-sm" readonly="readonly" type="text" id="single_qnty" name="single_qnty" value="'+response["singles_room"]+'"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="single_adults" name="single_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="single_children" name="single_children" value="0"></td>' +
                        '<td><input class="form-control input-sm single_pax" type="text" value="" id="single_pax" name="single_pax"></td>' +
                        '<td><input class="form-control input-sm single_vat" readonly="readonly" type="text" value="" id="single_vat" name="single_vat"></td>' +
                        '<td><input class="form-control input-sm single_sc" readonly="readonly" type="text" value="" id="single_sc" name="single_sc"></td>' +
                        '<td><input class="form-control input-sm single_tl" readonly="readonly" type="text" value="" id="single_tl" name="single_tl"></td>' +
                        '<td><input class="form-control input-sm single_total" readonly="readonly" type="text" value="" id="single_total" name="single_total"></td>' +
                        '<td><input class="form-control input-sm singles_room" type="text" value="" id="single_price" name="single_price"></td>' +
                        '<td class="text-center"><span id="single_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    if (response["executive_room"]>0){
                        $('#order_table_body').append('<tr>' +
                        '<td>Executive</td>' +
                        '<td><input class="form-control input-sm" readonly="readonly" type="text" id="double_qnty" name="double_qnty" value="'+response["executive_room"]+'"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="double_adults" name="double_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="double_children" name="double_children" value="0"></td>' +
                        '<td><input class="form-control input-sm double_pax" type="text" value="" id="double_pax" name="double_pax"></td>' +
                        '<td><input class="form-control input-sm double_vat" readonly="readonly" type="text" value="" id="double_vat" name="double_vat"></td>' +
                        '<td><input class="form-control input-sm double_sc" readonly="readonly" type="text" value="" id="double_sc" name="double_sc"></td>' +
                        '<td><input class="form-control input-sm double_tl" readonly="readonly" type="text" value="" id="double_tl" name="double_tl"></td>' +
                        '<td><input class="form-control input-sm double_total" readonly="readonly" type="text" value="" id="double_total" name="double_total"></td>' +
                        '<td><input class="form-control input-sm executive_room" type="text" value="" id="double_price" name="double_price"></td>' +
                        '<td class="text-center"><span id="double_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    if (response["twin_room"]>0){
                        ...
                        '<td><input class="form-control input-sm" type="text" id="twin_adults" name="twin_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="twin_children" name="twin_children" value="0"></td>' +
                        '<td><input class="form-control input-sm twin_pax" type="text" value="" id="twin_pax" name="twin_pax"></td>' +
                        '<td><input class="form-control input-sm twin_vat" readonly="readonly" type="text" value="" id="twin_vat" name="twin_vat"></td>' +
                        '<td><input class="form-control input-sm twin_sc" readonly="readonly" type="text" value="" id="twin_sc" name="twin_sc"></td>' +
                        '<td><input class="form-control input-sm twin_tl" readonly="readonly" type="text" value="" id="twin_tl" name="twin_tl"></td>' +
                        '<td><input class="form-control input-sm twin_total" readonly="readonly" type="text" value="" id="twin_total" name="twin_total"></td>' +
                        '<td><input class="form-control input-sm twin_room" type="text" value="" id="twin_price" name="twin_price"></td>' +
                        '<td class="text-center"><span id="twin_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    if (response["superior_room"]>0){
                        $('#order_table_body').append('<tr>' +
                        '<td>Superior</td>' +
                        '<td><input class="form-control input-sm" readonly="readonly" type="text" id="triple_qnty" name="triple_qnty" value="'+response["superior_room"]+'"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="triple_adults" name="triple_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="triple_children" name="triple_children" value="0"></td>' +
                        '<td><input class="form-control input-sm triple_pax" type="text" value="" id="triple_pax" name="triple_pax"></td>' +
                        '<td><input class="form-control input-sm triple_vat" readonly="readonly" type="text" value="" id="triple_vat" name="triple_vat"></td>' +
                        '<td><input class="form-control input-sm triple_sc" readonly="readonly" type="text" value="" id="triple_sc" name="triple_sc"></td>' +
                        '<td><input class="form-control input-sm triple_tl" readonly="readonly" type="text" value="" id="triple_tl" name="triple_tl"></td>' +
                        '<td><input class="form-control input-sm triple_total" readonly="readonly" type="text" value="" id="triple_total" name="triple_total"></td>' +
                        '<td><input class="form-control input-sm superior_room" type="text" value="" id="triple_price" name="triple_price"></td>' +
                        '<td class="text-center"><span id="triple_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    if (response["deluxe_room"]>0){
                        $('#order_table_body').append('<tr>' +
                        '<td>Deluxe</td>' +
                        '<td><input class="form-control input-sm" readonly="readonly" type="text" id="family_qnty" name="family_qnty" value="'+response["deluxe_room"]+'"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="family_adults" name="family_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="family_children" name="family_children" value="0"></td>' +
                        '<td><input class="form-control input-sm family_pax" type="text" value="" id="family_pax" name="family_pax"></td>' +
                        '<td><input class="form-control input-sm family_vat" readonly="readonly" type="text" value="" id="family_vat" name="family_vat"></td>' +
                        '<td><input class="form-control input-sm family_sc" readonly="readonly" type="text" value="" id="family_sc" name="family_sc"></td>' +
                        '<td><input class="form-control input-sm family_tl" readonly="readonly" type="text" value="" id="family_tl" name="family_tl"></td>' +
                        '<td><input class="form-control input-sm family_total" readonly="readonly" type="text" value="" id="family_total" name="family_total"></td>' +
                        '<td><input class="form-control input-sm deluxe_room" type="text" value="" id="family_price" name="family_price"></td>' +
                        '<td class="text-center"><span id="family_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    if (response["standard_room"]>0){
                        $('#order_table_body').append('<tr>' +
                        '<td>Standard</td>' +
                        '<td><input class="form-control input-sm" readonly="readonly" type="text" id="honeymoon_qnty" name="honeymoon_qnty" value="'+response["standard_room"]+'"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="honeymoon_adults" name="honeymoon_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="honeymoon_children" name="honeymoon_children" value="0"></td>' +
                        '<td><input class="form-control input-sm honeymoon_pax" type="text" value="" id="honeymoon_pax" name="honeymoon_pax"></td>' +
                        '<td><input class="form-control input-sm honeymoon_vat" readonly="readonly" type="text" value="" id="honeymoon_vat" name="honeymoon_vat"></td>' +
                        '<td><input class="form-control input-sm honeymoon_sc" readonly="readonly" type="text" value="" id="honeymoon_sc" name="honeymoon_sc"></td>' +
                        '<td><input class="form-control input-sm honeymoon_tl" readonly="readonly" type="text" value="" id="honeymoon_tl" name="honeymoon_tl"></td>' +
                        '<td><input class="form-control input-sm honeymoon_total" readonly="readonly" type="text" value="" id="honeymoon_total" name="honeymoon_total"></td>' +
                        '<td><input class="form-control input-sm standard_room" type="text" value="" id="honeymoon_price" name="honeymoon_price"></td>' +
                        '<td class="text-center"><span id="honeymoon_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    if (response["extra_bed"]>0){
                        ...
                        '<td><input class="form-control input-sm" type="text" id="extra_bed_adults" name="extra_bed_adults" value="0"></td>' +
                        '<td><input class="form-control input-sm" type="text" id="extra_bed_children" name="extra_bed_children" value="0"></td>' +
                        '<td><input class="form-control input-sm extra_bed_pax" type="text" value="" id="extra_bed_pax" name="extra_bed_pax"></td>' +
                        '<td><input class="form-control input-sm extra_bed_vat" readonly="readonly" type="text" value="" id="extra_bed_vat" name="extra_bed_vat"></td>' +
                        '<td><input class="form-control input-sm extra_bed_sc" readonly="readonly" type="text" value="" id="extra_bed_sc" name="extra_bed_sc"></td>' +
                        '<td><input class="form-control input-sm extra_bed_tl" readonly="readonly" type="text" value="" id="extra_bed_tl" name="extra_bed_tl"></td>' +
                        '<td><input class="form-control input-sm extra_bed_total" readonly="readonly" type="text" value="" id="extra_bed_total" name="extra_bed_total"></td>' +
                        '<td><input class="form-control input-sm extra_bed" type="text" value="" id="extra_bed_price" name="extra_bed_price"></td>' +
                        '<td class="text-center"><span id="extra_bed_amount" class="text-center">0</span></td>' +
                        '</tr>');
                    }
                    getTotalQnty();
        ...
        $("body").on("keydown", "input.singles_room", function (e) {
        ...
        $("body").on("keydown", "input.executive_room", function (e) {
        ...
        $("body").on("keydown", "input.superior_room", function (e) {
        ...
        $("body").on("keydown", "input.deluxe_room", function (e) {
        ...
        $("body").on("keydown", "input.standard_room", function (e) {
