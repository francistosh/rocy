    ...
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}, null, null, null, {"bSortable": false}],
            ...
            {column_number: 3, filter_default_label: "[<?=lang('group_name');?>]", filter_type: "text", data: []},
            ...
            {column_number: 11, filter_default_label: "[<?=lang('check_in_date');?> (dd-mm-yyyy)]", filter_type: "text", data: []},
            {column_number: 12, filter_default_label: "[<?=lang('check_out_date');?> (dd-mm-yyyy)]", filter_type: "text", data: []},
        ], "footer");
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
             ...
             <!--   <h4 style="font-weight: bold;">TOTAL KES <?= number_format($total_kes->total,2); ?></h4>
                <h4 style="font-weight: bold;">TOTAL US <?= number_format($total_us->total,2); ?></h4> -->
