                ...
                <div id="pos">
                    ...
                    <div id="leftdiv">
                        ...
                        <div id="left-top">
                            ...
                            <div class="form-group">
                                <?= form_input('room', null, 'id="room1" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("room") . '" required="required" class="form-control" style="width:100%;"'); ?>
                            </div>
                                       ...
                                       <!-- <div class="btn-group">
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-success" id="payment">
                                                <i class="fa fa-money"></i> <?= lang('Submit'); ?>
                                            </button>
                                        </div>
                                    </div>
                                </div>
        ...
        $('#room1').select2({
            ...
            initSelection: function (element, callback) {
                $.ajax({
                    ...
                    url: site.base_url+"rooms/getRoom/" + $(element).val(),
                    dataType: "json",
            ...
            ajax: {
                url: site.base_url + "rooms/suggestions",
                dataType: 'json',
                quietMillis: 15,
