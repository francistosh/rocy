...
<div id="wrapper">
 ...
 <h3 style="text-transform:uppercase;"><b>ROCY HOTEL</b></h3>
             <h3><b>Receipt No: </b><?= $inv->id; ?></h3>
            <?php
			$data1 = 'RECEIPT NO: '.$inv->id.''. PHP_EOL;
						$this->load->helper('file');
				//echo "PIN # - P000601088Q "." "."P.O Box 10538 - 00200";
           ...
           // echo "Chef" . ": " . $inv->chef . "</br>";
            ...
            <table class="table table-striped table-condensed" width="100%">
                ...
                foreach ($rows as $row) {
                    ...
                    echo $this->sma->formatMoney($row->net_unit_price + ($row->item_tax / $row->quantity)) .')<span class="pull-right">'.$sale->currency.' '.$this->sma->formatMoney($row->subtotal) . '</span></tr>';
                ...
                <tr>
                    ...
                    <th style="font-size:13px" class="text-right"><?= $sale->currency.' '.$this->sma->formatMoney($inv->total + $inv->product_tax); ?></th>
					<?php 
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <th class="text-right"><?= $sale->currency.' '.$this->sma->formatMoney($inv->grand_total + $rounding); ?></th>
                    </tr>
                <?php } else { ?>
                    <tr>
                        <th style="font-size:13px"><?= lang("grand_total"); ?></th>
                        <th class="text-right"><?= $sale->currency.' '.$this->sma->formatMoney($inv->grand_total); ?></th>
                    </tr>
                <?php
                ...
                if ($inv->paid < $inv->grand_total) { ?>
                 <!--   <tr>
                    ...
                    <tr>
                        ...
                        <th class="text-right"><?= $sale->currency.' '.$this->sma->formatMoney($inv->grand_total - $inv->paid); ?></th>
                    </tr>

                <?php }
  echo '<p>Room Name : '.$room->name.'</p>';
