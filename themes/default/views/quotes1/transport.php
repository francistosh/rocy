    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: function (request, response) {
				...
				if (!$('#chkindate').val()) {
                   // $('#add_item').val('').removeClass('ui-autocomplete-loading');
                    bootbox.alert('<?=lang('Select From_Date and To_Date');?>');
                    //response('');
                    //$('#chkindate').focus();
                    return false;
                }
                $.ajax({
                    ...
                    data: {
                        ...
                        customer_id: $("#trcustomer").val(),
						checkin_date: $("#chkindate").val(),
						chkout_date:$("#chkoutdate").val(),
						rtype: $("#rtype").val()
                    },
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php// if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Quote_date", "qudate"); ?>
                                     <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control datetime" id="qudate"'); ?>
                                    <?php //echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" id="qudate" required="required"'); ?>
                                </div>
                            </div>
							<div class="col-md-4" >
                                <div class="form-group">
                                    <?= lang("From_Date", "chkindate"); ?>
                       ...
                       // } ?>
						...
						<div class="col-md-4" style="display: none">
                            <div class="form-group">
                                <?= lang("No_of_Rooms", "nrooms"); ?>
                                <?php echo form_input('nrooms',  '', 'class="form-control input-tip" id="nrooms"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <?= lang("Meal_Plan", "qcategory") ?>
                        <?php
                        $cat[''] = "";
                        foreach ($categories as $category) {
                            $cat[$category->id] = $category->name;
                        }
                        echo form_dropdown('qcategory', $cat, (isset($_POST['category']) ? $_POST['category'] : ($product ? $product->category_id : '')), 'class="form-control select" id="qcategory" placeholder="' . lang("select") . " " . lang("category") . '" required="required" style="width:100%"')
                        ?>
							</div>
                        </div>
                        <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <?php //if ($Owner || $Admin) { ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?= lang("Transport_type", "quwarehouse"); ?>
                                                <?php
                                                $wh[''] = '';
									...
									<div class="col-md-4">
                                            <div class="form-group">
                                                <?= lang("customer", "trcustomer"); ?>
                                                <?php
                                                $cst[''] = '';
                                                foreach ($customers as $customer) {
                                                    $cst[$customer->id] = $customer->name;
                                                }
                                                echo form_dropdown('trcustomer', $cst, (''), 'id="trcustomer" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" required="required" style="width:100%;" ');
                                                ?>
                                            </div>
                                        </div>
                        ...
                        echo form_dropdown('rtype', $opts, (isset($_POST['rtype']) ? $_POST['rtype'] : ($product ? $product->type : '')), 'class="form-control" id="rtype" ');
                        ?>
                                ...
                                <div class="controls table-controls">
                                    <table id="quTable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-1"><?= lang("Price_per_Day"); ?></th>
                                            <th class="col-md-1"><?= lang("No_of_Days"); ?></th>
											<!--<th class="col-md-1"><?= lang("No_of_Rooms"); ?></th> -->
                                            <?php
                        ...
                        <div class="row" id="bt">
                            <div class="col-sm-12">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <?= lang("note", "qunote"); ?>
                                        <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : ""), 'class="form-control" id="qunote" '); ?>
