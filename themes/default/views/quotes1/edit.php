<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($inv) { ?>
        localStorage.setItem('createdon', '<?=  date($dateFormats['php_ldate'], strtotime($inv->created_on))?>');
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Quote_date", "createdon");?>
                                    <?php echo form_input('date', (isset($_POST['created_on']) ? $_POST['created_on'] : $inv->created_on), 'class="form-control input-tip" id="createdon" required="required" readonly="true"'); ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Check_In", "chkindate"); ?>
                                     <?php echo form_input('chkindate', (isset($_POST['date']) ? $_POST['date'] : $inv->chkindate), 'class="form-control datetime" id="chkindate"'); ?>
							...
							<div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Check_Out", "chkoutdate"); ?>
                                     <?php echo form_input('chkoutdate', (isset($_POST['date']) ? $_POST['date'] : $inv->chkoutdate), 'class="form-control datetime" id="chkoutdate"'); ?>
                                    <?php //echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" id="qudate" required="required"'); ?>
                                </div>
                            </div>
                        <?php //} ?>
