...
//$daydifferebce = $difference->d;
                ...
                <div class="col-xs-4">
                    ...
                    <div class="col-xs-10">
                        ...
                        <p style="font-weight:bold;"><?= lang("Quote_date"); ?>
                            ...
                            : <?= date ('d/m/Y', strtotime($inv->chkoutdate ));
                ...
                <div class="table-responsive">
					...
					<thead>
                        <tr>
                            ...
                            <th style="padding-right:20px;"><?= lang("Price_per_Day"); ?></th>
                            <?php
                            if ($Settings->tax1) {
					...
					<?php // Else
                        ...
                        <tr>
                            ...
                            <th><?= lang("description"); ?></th>
                            <th><?= lang("Pax"); ?></th>
                            <th style="padding-right:20px;"><?= lang("Price_per_Pax"); ?></th>
							 <th style="padding-right:20px;"><?= lang("No_of_Rooms"); ?></th>
                            <?php
                            if ($Settings->tax1) {
                                echo '<th style="padding-right:20px; text-align:center; vertical-align:middle;">' . lang("tax") . '</th>';
                            }
		...
		<?php } else { ?>
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="width: 120px; text-align:center; vertical-align:middle;"><?= $this->sma->formatNumber($row->quantity); ?></td>
                                <td style="text-align:right; width:100px; padding-right:10px;"><?= $this->sma->formatMoney($row->net_unit_price); ?></td>
								<td style="text-align:right; width:100px; padding-right:10px;"><?= $this->sma->formatNumber($row->no_of_rooms); ?></td>
                                <?php
                                if ($Settings->tax1) {
                                    echo '<td style="width: 120px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 && $row->tax_code ? '<small>(' . $row->tax_code . ')</small> ' : '') . $this->sma->formatMoney($row->item_tax) . '</td>';
                                }
		...
		<?php } ?>
                        ...
                        ?>
                        <tr>
                            <td colspan="<?php if ($inv->category_id == '10'){ echo $tcol;} else {echo $tcol+1;}; ?>"
                        ...
                        if ($inv->order_discount != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("order_discount") . ' (' . $inv->currency . ')</td><td style="text-align:right; padding-right:10px;">' . $this->sma->formatMoney($inv->order_discount) . '</td></tr>';
                        }
                        if ($Settings->tax2 && $inv->order_tax != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("order_tax") . ' (' . $inv->currency . ')</td><td style="text-align:right; padding-right:10px;">' . $this->sma->formatMoney($inv->order_tax) . '</td></tr>';
                        }
                        if ($inv->shipping != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("shipping") . ' (' . $inv->currency . ')</td><td style="text-align:right; padding-right:10px;">' . $this->sma->formatMoney($inv->shipping) . '</td></tr>';
                        }
                        ?>
                        <tr>
                            <td colspan="<?php if ($inv->category_id == '10'){ echo $tcol;} else {echo $tcol+1;}; ?>"
