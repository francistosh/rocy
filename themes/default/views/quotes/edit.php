<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		localStorage.setItem('att', '<?=$inv->att?>');
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("ATT", "att"); ?>
                                <?php echo form_input('att_edit', (isset($_POST['att_edit']) ? $_POST['att_edit'] : $inv->att), 'class="form-control input-tip" id="att"'); ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("Ref", "ref"); ?>
                                <?php echo form_input('ref_edit', (isset($_POST['ref_edit']) ? $_POST['ref_edit'] : $inv->ref), 'class="form-control input-tip" id="ref"'); ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("Pax", "pax"); ?>
                                <?php echo form_input('pax_edit', (isset($_POST['pax_edit']) ? $_POST['pax_edit'] : $inv->pax), 'class="form-control input-tip" id="pax"'); ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("From", "fromdate"); ?>
                                 <?php echo form_input('fromdate_dit', (isset($_POST['fromdate_dit']) ? $_POST['fromdate_dit'] : date('d/m/Y',strtotime($inv->chkindate))), 'class="form-control input-tip date" id="fromdate" required="required"'); ?>
						...
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("To", "todate"); ?>
                                 <?php echo form_input('todate_edit', (isset($_POST['todate_edit']) ? $_POST['todate_edit'] : date('d/m/Y',strtotime($inv->chkoutdate))), 'class="form-control input-tip date" id="todate" required="required"'); ?>
                            ...
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="quTable"
                                        ...
                                        <thead>
                                        <tr>
                                            <th class="col-md-4"><?= lang("Item_Description") . " "; ?></th>
                                            <th class="col-md-1"><?= lang("unit_price")."(UGX)"; ?></th>
                                            <th class="col-md-1"><?= lang("quantity"); ?></th>
											<th class="col-md-1"><?= lang("Days"); ?></th>
                                            <?php /*
