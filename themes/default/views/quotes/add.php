                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("ATT", "att"); ?>
                                <?php echo form_input('att', (isset($_POST['att']) ? $_POST['att'] : $qunumber), 'class="form-control input-tip" id="att"'); ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("Ref", "ref"); ?>
                                <?php echo form_input('ref', (isset($_POST['ref']) ? $_POST['ref'] : $qunumber), 'class="form-control input-tip" id="ref"'); ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("Pax", "pax"); ?>
                                <?php echo form_input('pax', (isset($_POST['pax']) ? $_POST['pax'] : $qunumber), 'class="form-control input-tip" id="pax"'); ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("From", "fromdate"); ?>
                                 <?php echo form_input('fromdate', (isset($_POST['fromdate']) ? $_POST['fromdate'] : ""), 'class="form-control input-tip date" id="fromdate" required="required"'); ?>
						...
						<div class="col-md-4">
                            <div class="form-group" >
                                <?= lang("To", "todate"); ?>
                                 <?php echo form_input('todate', (isset($_POST['todate']) ? $_POST['todate'] : ""), 'class="form-control input-tip date" id="todate" required="required"'); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="mname" class="col-sm-4 control-label"><?= lang('Item_Description') ?> *</label>
					...
					<div class="form-group">
                        <label for="mdays" class="col-sm-4 control-label"><?= lang('Days') ?> *</label>
