        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-xs-4">
                    ...
                    <div class="col-xs-10">
					<p style="font-weight:bold;"><?= lang("Quote Date:"); ?>
                            : <?= $this->sma->hrld($inv->date); ?></p>
							
                        <p style="font-weight:bold;"><?= lang("ATT"); ?>:   <?= $inv->att; ?></p>
						 <p style="font-weight:bold;"><?= lang("REF"); ?>:   <?= $inv->ref; ?></p>
						  <p style="font-weight:bold;"><?= lang("PAX"); ?>:   <?= $inv->pax; ?></p>
                        <p style="font-weight:bold;"><?= lang("DATE"); ?>: <?= date('d-M-Y',strtotime($inv->chkindate)); ?> to <?= date('d-M-Y',strtotime($inv->chkoutdate)); ?></p>
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="width: 120px; text-align:center; vertical-align:middle;"><?= $this->sma->formatNumber($row->days); ?></td>
                                <?php
                                if ($Settings->tax1) {
