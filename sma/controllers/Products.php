...
//        }
    ...
    function getProducts($warehouse_id = NULL)
    {
        ...
        if ($warehouse_id) {
            $this->datatables
                ->select($this->db->dbprefix('warehouses_products') . ".product_id as productid, " . $this->db->dbprefix('products') . ".image as image, " . $this->db->dbprefix('products') . ".code as code, " . $this->db->dbprefix('products') . ".name as name, " . $this->db->dbprefix('categories') . ".name as cname,sma_warehouses.name as wname, sma_products.price as price, '' as quantity, sma_products.unit, " . $this->db->dbprefix('warehouses_products') . ".rack as rack, sma_products.alert_quantity", FALSE)
				...
				->join('sma_warehouses', 'sma_warehouses.id=sma_products.warehouse', 'left')
                ->where('sma_products.warehouse', $warehouse_id)
                //->where('warehouses_products.quantity !=', 0)
                ->group_by("sma_warehouses_products.product_id");
        } else {
            $this->datatables
                ->select($this->db->dbprefix('products') . ".id as productid, " . $this->db->dbprefix('products') . ".image as image, " . $this->db->dbprefix('products') . ".code as code, " . $this->db->dbprefix('products') . ".name as name, " . $this->db->dbprefix('categories') . ".name as cname, sma_warehouses.name as wname, sma_products.price as price, '' as quantity, sma_products.unit, NULL as rack, sma_products.alert_quantity", FALSE)
                ->from('sma_products')
                ->join('sma_categories', 'sma_products.category_id=sma_categories.id', 'left')
				->join('sma_warehouses', 'sma_warehouses.id=sma_products.warehouse', 'left')
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($this->input->post('iskitchen')) {
                ...
                $iskitchen=0;     
                 ...
                 if ($this->input->post('inventory')=="on") {
                $inventory=1;
                 }else{
                $inventory=0;     
                 }
            ...
            $data = array(
                ...
                'price' => $this->sma->formatDecimal($this->input->post('rsdnt_amount')),
                ...
                'iskitchen' => $iskitchen,
                'portion1' => $this->sma->fld($this->input->post('from_date')),
				'to_date' => $this->sma->fld($this->input->post('todate')),
                'portion1qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount')),
				'nrsdnt_amount' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount')),
                'portion2' => $this->sma->fld($this->input->post('from_date2')),
				'todate2' =>  $this->sma->fld($this->input->post('to_date2')),
                'portion2qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount2')),
				'nrsdnt_amount2' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount2')),
				'portion3' => $this->sma->fld($this->input->post('from_date3')),
				'todate3' =>  $this->sma->fld($this->input->post('to_date3')),
                'portion3qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount3')),
				'nrsdnt_amount3' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount3')),
                //'portion4' => date('Y-m-d', strtotime($this->input->post('from_date4'))),
				'portion4' => $this->sma->fld($this->input->post('from_date4')),
				'todate4' =>  $this->sma->fld($this->input->post('to_date4')),
                'portion4qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount4')),
				'nrsdnt_amount4' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount4')),
				'portion5' =>  $this->sma->fld($this->input->post('from_date5')),

				'todate5' =>  $this->sma->fld($this->input->post('to_date5')),
                'portion5qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount5')),
				'nrsdnt_amount5' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount5')),
				'portion6' =>  $this->sma->fld($this->input->post('from_date6')),
				'todate6' =>  $this->sma->fld($this->input->post('to_date6')),
                'portion6qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount6')),
				'nrsdnt_amount6' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount6')),
				'portion7' =>  $this->sma->fld($this->input->post('from_date7')),
				'todate7' =>  $this->sma->fld($this->input->post('to_date7')),
                'portion7qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount7')),
				'nrsdnt_amount7' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount7')),
				'portion8' =>  $this->sma->fld($this->input->post('from_date8')),
				'todate8' =>  $this->sma->fld($this->input->post('to_date8')),
                'portion8qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount8')),
				'nrsdnt_amount8' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount8')),
				'portion9' =>  $this->sma->fld($this->input->post('from_date9')),
				'todate9' =>  $this->sma->fld($this->input->post('to_date9')),
                'portion9qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount9')),
				'nrsdnt_amount9' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount9')),
...
//    }
    ...
    function edit($id = NULL)
    {
        ...
        if ($this->form_validation->run('products/add') == true) {
            ...
            $data = array('code' => $this->input->post('code'),
                ...
                'details' => $this->input->post('details'),
                'product_details' => $this->input->post('product_details'),
                'supplier1' => $this->input->post('supplier_2'),
                'supplier1price' => $this->sma->formatDecimal($this->input->post('supplier_price')),
                'supplier2' => $this->input->post('supplier_2'),
                'supplier2price' => $this->sma->formatDecimal($this->input->post('supplier_2_price')),
                'supplier3' => $this->input->post('supplier_3'),
                ...
                'portion1qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount')),
				'nrsdnt_amount' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount')),
				//if($product->portion2qty){
                'portion2' => $this->sma->fld($this->input->post('from_date2')),
				'todate2' =>   $this->sma->fld($this->input->post('to_date2')),
                'portion2qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount2')),
				'nrsdnt_amount2' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount2')),
				//}
				//if($product->portion3qty){
				'portion3' => $this->sma->fld($this->input->post('from_date3')),
				'todate3' =>  $this->sma->fld($this->input->post('to_date3')),
                'portion3qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount3')),
				'nrsdnt_amount3' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount3')),
			//	}
				//if($product->portion4qty){
                'portion4' => $this->sma->fld($this->input->post('from_date4')),
				'todate4' => $this->sma->fld($this->input->post('to_date4')),
                'portion4qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount4')),
				'nrsdnt_amount4' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount4')),
				//}
				//if($product->portion5qty){
				'portion5' => $this->sma->fld($this->input->post('from_date5')),
				'todate5' =>  $this->sma->fld($this->input->post('to_date5')),
                'portion5qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount5')),
				'nrsdnt_amount5' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount5')),
				...
				'todate9' =>  $this->sma->fld($this->input->post('to_date9')),
                'portion9qty' => $this->sma->formatDecimal($this->input->post('rsdnt_amount9')),
				'nrsdnt_amount8' => $this->sma->formatDecimal($this->input->post('nrsdnt_amount9')),
            );
            $this->load->library('upload');
            if ($this->input->post('type') == 'standard') {
    ...
    function getadjustments($pdf = NULL, $xls = NULL)
    {
        ...
        if ($pdf || $xls) {
            ...
            $this->db
                ->select($this->db->dbprefix('adjustments') . ".id as did, " . $this->db->dbprefix('adjustments') . ".product_id as productid, " . $this->db->dbprefix('adjustments') . ".date as date, " . $this->db->dbprefix('products') . ".image as image, " . $this->db->dbprefix('products') . ".code as code, " . $this->db->dbprefix('products') . ".name as pname, " . $this->db->dbprefix('product_variants') . ".name as vname, " . $this->db->dbprefix('adjustments') . ".quantity as quantity, ".$this->db->dbprefix('adjustments') . ".type,".$this->db->dbprefix('adjustments') . ".reason,".$this->db->dbprefix('adjustments') . ".reference, " . $this->db->dbprefix('warehouses') . ".name as wh,".$this->db->dbprefix('adjustments') . ".created_by,".$this->db->dbprefix('adjustments') . ".checked_by");
            ...
            if (!empty($data)) {
                ...
                $this->excel->getActiveSheet()->SetCellValue('F1', lang('type'));
                 $this->excel->getActiveSheet()->SetCellValue('G1', lang('reason'));
                  $this->excel->getActiveSheet()->SetCellValue('H1', lang('reference'));
                $this->excel->getActiveSheet()->SetCellValue('I1', lang('warehouse'));
$this->excel->getActiveSheet()->SetCellValue('J1', lang('returned_by'));
$this->excel->getActiveSheet()->SetCellValue('K1', lang('checked_by'));
                $row = 2;
                foreach ($data as $data_row) {
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('F' . $row, lang($data_row->type));
                      $this->excel->getActiveSheet()->SetCellValue('G' . $row, lang($data_row->reason));
                        $this->excel->getActiveSheet()->SetCellValue('H' . $row, $data_row->reference);
                    $this->excel->getActiveSheet()->SetCellValue('I' . $row, $data_row->wh);
                      $this->excel->getActiveSheet()->SetCellValue('J' . $row, $data_row->returned_by);
                        $this->excel->getActiveSheet()->SetCellValue('K' . $row, $data_row->checked_by);
                    $row++;
                }
            ...
            $this->load->library('datatables');
            $this->datatables
                     ->select($this->db->dbprefix('adjustments') . ".id as did, " . $this->db->dbprefix('adjustments') . ".product_id as productid, " . $this->db->dbprefix('adjustments') . ".date as date, " . $this->db->dbprefix('products') . ".image as image, " . $this->db->dbprefix('products') . ".code as code, " . $this->db->dbprefix('products') . ".name as pname, " . $this->db->dbprefix('product_variants') . ".name as vname, " . $this->db->dbprefix('adjustments') . ".quantity as quantity, ".$this->db->dbprefix('adjustments') . ".type,".$this->db->dbprefix('adjustments') . ".reason,".$this->db->dbprefix('adjustments') . ".reference, " . $this->db->dbprefix('warehouses') . ".name as wh,".$this->db->dbprefix('users') . ".username,".$this->db->dbprefix('adjustments') . ".checked_by");
            ...
            $this->datatables->join('warehouses', 'warehouses.id=adjustments.warehouse_id', 'left');
             $this->datatables->join('users', 'adjustments.created_by=users.id', 'left');
