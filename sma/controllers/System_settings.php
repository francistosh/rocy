...
class system_settings extends MY_Controller
{
    ...
    function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array('site_name' => DEMO ? 'Stock Manager Advance' : $this->input->post('site_name'),
                ...
                'payment_name' => $this->input->post('payment_name') ? $this->input->post('payment_name') : NULL,
                'acc_no' => $this->input->post('acc_no') ? $this->input->post('acc_no') : NULL,
                'enable_tax' => $this->input->post('enable_tax') ? $this->input->post('enable_tax') : NULL,
                'vat' => $this->input->post('vat') ? $this->input->post('vat') : NULL,
                'service_charge' => $this->input->post('service_charge') ? $this->input->post('service_charge') : NULL,
                'tourism_fund' => $this->input->post('tourism_fund') ? $this->input->post('tourism_fund') : NULL,
            );
    ...
    function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'vouchers-index' => $this->input->post('vouchers-index'),
                'vouchers-add' => $this->input->post('vouchers-add'),
                'vouchers-edit' => $this->input->post('vouchers-edit'),
                'vouchers-delete' => $this->input->post('vouchers-delete'),
                ...
                'service-vouchers-index' => $this->input->post('service-vouchers-index'),
                'service-vouchers-add' => $this->input->post('service-vouchers-add'),
                'service-vouchers-edit' => $this->input->post('service-vouchers-edit'),
                'service-vouchers-delete' => $this->input->post('service-vouchers-delete'),
                'service-vouchers-check_in' => $this->input->post('service-vouchers-check_in'),
                'service-vouchers-email' => $this->input->post('service-vouchers-email'),
                'service-vouchers-pdf' => $this->input->post('service-vouchers-pdf'),
                'guests-index' => $this->input->post('guests-index'),
                'guests-edit' => $this->input->post('guests-edit'),
                'guests-delete' => $this->input->post('guests-delete'),
                'guests-record-temperature' => $this->input->post('guests-record-temperature'),
                'guests-check-out' => $this->input->post('guests-check-out'),
                ...
                'rooms-index' => $this->input->post('rooms-index'),
                'rooms-add' => $this->input->post('rooms-add'),
                'rooms-edit' => $this->input->post('rooms-edit'),
                'rooms-delete' => $this->input->post('rooms-delete'),
                'rooms-pdf' => $this->input->post('rooms-pdf'),
                'rooms-bill' => $this->input->post('rooms-bill'),
            );
    ...
    function getCategories()
    {
        ...
        $this->load->library('datatables');
        $this->datatables
            ->select("id, priority, image, code, name")
            ->from("categories")
