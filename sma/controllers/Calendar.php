...
class Calendar extends MY_Controller
{
    ...
    function index($year = NULL, $month = NULL)
    {
		...
		{table_open}<table border="0" style="font-size:12px" cellpadding="0" cellspacing="0" class="table table-bordered" style="min-width:522px;">{/table_open}
        ...
        $calendardata=$this->calendar->generate($year, $month, $cal_data);
        // die(print_r($cal_data));
