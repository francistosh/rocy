 ...
 */
$config['site_title']                 = "Stock Manager";       // Site Title, example.com This is not more functional
$config['admin_email']                = "krufed@gmail.com"; // Admin Email, admin@example.com This is not more functional
